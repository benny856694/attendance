...
namespace VideoHelper
{
    ...
    public delegate void MessageReceivedEventHandler(TlvclientV sender, int sysType, int majorVersion, int minorVersion, int msgType, int? ack, byte[] _v);
    public class TlvclientV
    {
        ...
        public TlvclientV(string _ip, int _port)
        {
