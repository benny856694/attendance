...
namespace huaanClient
{
    class UtilsJson
    {
        public static string PersonJson64 = "{{\"version\": \"0.9\",\"cmd\": \"add person\",\"id\": \"{0}\",\"name\": \"{1}\",\"role\": 1,\"feature_unit_size\": 0,\"feature_num\": 0,\"feature_data\": [],\"image_num\": 1,\"reg_images\": [{2}],\"norm_image_num\":1,\"norm_images\": [{3}],\"term\": \"forever\", \"term_start\":\"useless\",\"long_card_id\": {4}}}";
        public static string PersonJson32 = "{{\"version\": \"0.9\",\"cmd\": \"add person\",\"id\": \"{0}\",\"name\": \"{1}\",\"role\": 1,\"feature_unit_size\": 0,\"feature_num\": 0,\"feature_data\": [],\"image_num\": 1,\"reg_images\": [{2}],\"norm_image_num\":1,\"norm_images\": [{3}],\"term\": \"forever\", \"term_start\":\"useless\", \"wg_card_id\": {4}}}";
        public static string PersonJson = "{{\"version\": \"0.9\",\"cmd\": \"add person\",\"id\": \"{0}\",\"name\": \"{1}\",\"role\": 1,\"feature_unit_size\": 0,\"feature_num\": 0,\"feature_data\": [],\"image_num\": 1,\"reg_images\": [{2}],\"norm_image_num\":1,\"norm_images\": [{3}],\"wg_card_id\": 0,\"term\": \"forever\", \"term_start\":\"useless\"}}";
